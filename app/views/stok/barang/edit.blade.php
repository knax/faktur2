    ...
    <div class="col-md-12">
        <form action="/stok/barang/{{$barang->id}}" role="form" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="batas-keuntungan-bawah" name="batas_keuntungan_bawah" class="form-control" value="{{$barang->batas_keuntungan_bawah}}"/>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="batas-keuntungan-atas" name="batas_keuntungan_atas" class="form-control"  value="{{$barang->batas_keuntungan_atas}}"/>
                    <div class="input-group-addon">%</div>
                </div>
            </div>
